...
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
VOCdevkit_path      = 'VOCdevkit_luci'#_______记得修改根目录
'''

def voc_trainval(path,train_percent):
    trainval_percent    = 1
    random.seed(0)
    print("Generate txt in ImageSets.")
    segfilepath     = os.path.join(path, 'VOC2007/SegmentationClass')
    saveBasePath    = os.path.join(path, 'VOC2007/ImageSets/Segmentation')
